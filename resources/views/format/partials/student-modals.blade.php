@push('modals')
    ...
    <div class="modal fade app-modal" id="enrollStudentModal" tabindex="-1" aria-labelledby="enrollStudentModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div id="enrollAlert" class="alert alert-danger d-none"></div>

                    <input type="hidden" id="enrollStudentId" value="">

                    <div class="mb-2"><strong>Student:</strong> <span id="enrollStudentName">—</span></div>

                    <div class="mb-3">
                        <label for="enrollCourseId" class="form-label">Course</label>
                        <select id="enrollCourseId" class="form-select" required>
                    ...
                    <div class="mb-3">
                        <label for="enrollSection" class="form-label">Section</label>
                        <input id="enrollSection" type="text" class="form-control" placeholder="e.g. BSIT-2A" />
                    </div>

                    @if($roleForModal === 'admin')
                        <div class="mb-3">
                            <label for="enrollTeacherId" class="form-label">Teacher</label>
                            <select id="enrollTeacherId" class="form-select" required>
                    ...
                    @else
                        <input type="hidden" id="enrollTeacherId" value="">
                    @endif

	...
	<div class="card shadow-sm">
		<div class="card-header d-flex justify-content-between align-items-center">
			<div>
				...
				<small class="text-muted">Assign many students to one course with one teacher.</small>
			</div>
			<a href="{{ route('student.index') }}" class="btn-ui btn-ui--ghost">Back</a>
		</div>

		<div class="card-body">
			<div id="bulkEnrollAlert" class="alert alert-danger d-none"></div>
			...
			<div class="row mb-3 align-items-center">
				<div class="col-md-6 mb-2 mb-md-0">
					<div class="input-group">
						<input id="enrollStudentsSearch" type="search" class="form-control" placeholder="Search students...">
						<button id="enrollStudentsSearchBtn" class="btn btn-outline-secondary" type="button">Search</button>
						<button id="enrollStudentsClearSearch" class="btn btn-outline-secondary" type="button">Clear</button>
					</div>
				</div>
				<div class="col-md-6 text-md-end d-flex justify-content-md-end gap-2">
					...
					<button type="button" class="btn-ui btn-ui--primary" id="bulkEnrollBtn" data-url="{{ route('course.bulkEnroll') }}">Enroll Selected</button>
				</div>
			</div>

			<div id="enrollStudentsList" data-url="{{ route('enrollstudent.students') }}"></div>
		</div>
	</div>
</div>
@endsection
